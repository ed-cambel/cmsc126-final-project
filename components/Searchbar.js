    ...
    return (
        <header className='flex items-center gap-3 px-4 py-2.5 bg-white border-b border-gray-200'>
            ...
            <Link href="#" className='flex items-center gap-2 flex-shrink-0'>
                ...
                <span className='text-base font-medium whitespace-nowrap'>STaDi</span>
            </Link>

            {/* Search Bar */}
            <div className='flex-1 flex items-center gap-2.5 bg-gray-100 border border-gray-300 rounded-full px-4 h-[38px] shadow-sm'>
